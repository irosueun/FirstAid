...
public class FirstaidMod implements ModInitializer {
	...
	public static final PlacedFeature PLACED_HEART_CRYSTAL_SHARD_FEATURE = new PlacedFeature(Holder.createDirect(CONFIGURED_HEART_CRYSTAL_SHARD_FEATURE), List.of(CountPlacementModifier.create(20)));
